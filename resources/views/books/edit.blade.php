...
@section('content')
    <div class="row">
        <div class="col-md-8">
            ...
            <form action="{{ route('books.update', [$book->id]) }}" class="p-3 shadow-sm bg-white" enctype="multipart/form-data" method="POST">
                @csrf
                ...
                @if($book->cover)
                    <img src="{{ asset('storage/'.$book->cover) }}" alt="coverbook" width="96px">
                @endif
                <br><br>
                <input
                type="file"
